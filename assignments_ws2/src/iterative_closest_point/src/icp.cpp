...
// }
//
// Eigen::Matrix4d getFullTransformationMatrix(double roll, double pitch, double
// yaw,
//                                         double xTrans, double yTrans, double
//                                         zTrans){
//
//     // Rotation
//     Eigen::AngleAxisd zRotation = Eigen::AngleAxisd(yaw,
//     Eigen::Vector3d::UnitZ()); Eigen::AngleAxisd yRotation =
//     Eigen::AngleAxisd(pitch, Eigen::Vector3d::UnitY()); Eigen::AngleAxisd
//     xRotation = Eigen::AngleAxisd(roll, Eigen::Vector3d::UnitX());
//     Eigen::Matrix3d zyxRotationMatrix = zRotation.toRotationMatrix() *
//     yRotation.toRotationMatrix() * xRotation.toRotationMatrix();
//
//     // Translation
